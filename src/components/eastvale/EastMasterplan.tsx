...
const EastMasterplan = () => {
  ...
  const zones = m.zones.map((z, i) => ({
    ...z,
    icon: eastMasterplanIcon[m.zoneIcons[i] as keyof typeof eastMasterplanIcon],
  }));

  return (
    <section id="eastvale-masterplan" className="bg-white px-6 py-16 md:px-16 md:py-24">
